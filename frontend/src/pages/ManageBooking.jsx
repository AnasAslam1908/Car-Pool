                    ...
                    {rides.map((ride) => (
                        <tr key={ride.ride_id} className="text-center border">
                            ...
                            <td className="p-3 border flex flex-col md:flex-row justify-center items-center gap-2">
                                <button onClick={() => handleUpdate(ride.ride_id)} className="bg-blue-500 text-white px-3 py-1 rounded">Edit</button>
                                <button onClick={() => handleDelete(ride.ride_id)} className="bg-red-500 text-white px-3 py-1 rounded">Delete</button>
                                <select onChange={(e) => handleStatusChange(ride.ride_id, e.target.value)} value={ride.status} className="border px-2 py-1 rounded">
